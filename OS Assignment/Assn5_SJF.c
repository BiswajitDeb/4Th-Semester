...
void display_unsorted(int n,int Burst_time[],int Process[])
{
...
void Sorting(int n,int Burst_time[],int Process[])
{
    int temp_burst;
    int temp_value;
    int temp_process;
...
void completion_time (int n,int Burst_Time[],int Completion_Time[])
{
...
void display_sorted(int n,int Burst_time[],int Completion_Time[],int Turn_around_Time[],int Waiting_Time[],int process[])
{
    printf("Process\t\tBurst Time\t\tCompletion Time\t\tTurn Around Time\t\tWaiting Time\n");
    for(int i=0;i<n;i++)
    {
        printf("P%d\t\t%d\t\t\t%d\t\t\t%d\t\t\t%d\t\t\t\t%d\n",process[i]+1,Burst_time[i],Completion_Time[i],Turn_around_Time[i],Waiting_Time[i]);
    }
}

void Sorting_by_process(int n,int Burst_time[],int Completion_Time[],int Turn_around_Time[],int Waiting_Time[],int process[])
{
    int temp_burst;
    int temp_value;
    int temp_process;
...
int main()
{
    ...
    display_unsorted(n,Burst_time,Process);
    //sorting given processes
    Sorting(n,Burst_time,Process);
    ...
    completion_time(n,Burst_time,Completion_Time);
    Turn_Around(n,Completion_Time,Turn_around_Time);
    Waiting(n,Turn_around_Time,Burst_time,Waiting_Time);
    
    Sorting_by_process(n,Burst_time,Completion_Time,Turn_around_Time,Waiting_Time,Process);
    display_sorted(n,Burst_time,Completion_Time,Turn_around_Time,Waiting_Time,Process);
